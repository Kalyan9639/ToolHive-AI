...
class ContentGenerator:
    ...
    def get_new_rows(self):
        ...
        try:
            ...
            if self.last_processed_index == -1:
                # To avoid reprocessing old items if restarting script, you might handle this differently.
                # For now, we process starting from 0 if index is reset.
                pass 
    ...
    def parse_and_save(self, tool_name, tool_slug, content):
        ...
        entry = {
            'Tool Name': tool_name,
            'Slug': tool_slug,  # Added Slug here
        ...
        while True:
            ...
            if not new_rows.empty:
                ...
                for index, row in new_rows.iterrows():
                    ...
                    # Extract Slug safely (handle case if column missing in old CSVs)
                    tool_slug = row['Slug'] if 'Slug' in row else "unknown-slug"
